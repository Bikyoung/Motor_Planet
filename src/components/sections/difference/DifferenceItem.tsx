...
export default function DifferenceItem({imgSrc, title, desc}: IDifferenceItem) {
    return (
        <li className="flex items-center gap-20 px-[clamp(1.875rem,0.005rem+6.246vw,7.5rem)] bg-[#053B89] rounded-[10px] tablet:gap-md py-sm" data-aos="fade-right" data-aos-anchor-placement="bottom-center" data-aos-delay="500">
